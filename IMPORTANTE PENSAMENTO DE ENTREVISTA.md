...
- **Aproveitamento do tempo limitado**: Entrevistas têm restrições (*constraints*) de tempo; um bom pensamento de entrevista ajuda a usar esse tempo de forma eficaz.
...
- **Faça perguntas esclarecedoras**: Demonstre que você entende a importância de entender o contexto antes de solucionar.
